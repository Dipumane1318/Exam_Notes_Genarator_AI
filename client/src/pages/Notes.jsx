    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8">
      <motion.header
        ...
        className="mb-10
                  ...
                  flex md:items-center justify-between gap-4 flex-col md:flex-row relative z-50 overflow-visible"
      >
            ...
            <AnimatePresence>
              {showCredits && (
                <motion.div
                  ...
                  className="absolute right-[-15px] mt-4 w-64
            rounded-2xl
...
flex items-center gap-2"
      ...
      <motion.div className="mb-12 relative z-0">
        <TopicForm
          loading={loading}
          setResult={setResult}
          setError={setError}
