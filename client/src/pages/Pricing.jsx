...
${isSelected
          ...
          : popular
            ...
            : "border-gray-200"}
`}>
      {popular && !isSelected && <span className='absolute top-4 right-4 text-sm px-2 py-1 rounded bg-indigo-600 text-white'>
        Popular
      </span>}

      {isSelected && <span className='absolute top-4 right-4 text-sm px-2 py-1 rounded bg-black text-white'>
        Selected
      </span>}
